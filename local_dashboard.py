...
<span style="color: red; box-sizing: content-box; display: table;
  ...
  color: rgba(255,255,255,1);
  text-align: left;
  background: purple; ">Bilang ng Naka-admit: {}</span>
...
cumulative_case = go.Figure(data=[
    ...
    go.Scatter(x=cumulative_fig['Date'], y=cumulative_fig['Recoveries'], showlegend=False,
                                     line=dict(color='darkgreen', width=1, )),
    go.Bar(name='Bilang ng Namatay sa COVID-19', x=cumulative_fig['Date'], y=cumulative_fig['Deaths'],
           marker=dict(color='red', opacity=0.5)),
    go.Scatter(x=cumulative_fig['Date'], y=cumulative_fig['Deaths'], showlegend=False,
               line=dict(color='darkred', width=1)),
    ...
    go.Scatter(x=cumulative_fig['Date'], y=cumulative_fig['Admitted'], showlegend=False,
               line=dict(color='blue', width=1))])
...
st.plotly_chart(cumulative_case, use_container_width=True)
...
place_PH_bar.update_layout(showlegend=False, xaxis_title="Bilang ng mga Taong May Covid-19", yaxis_title="Lugar sa Pilipinas",
                               title= "Graph ng mga Lugar sa Pilipinas na may mga Kaso ng COVID-19",
